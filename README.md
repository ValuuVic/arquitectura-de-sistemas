...
La información se almacena temporalmente en un arreglo, por lo que no se utiliza una base de datos. Esta segunda entrega incorpora documentación automática e interactiva utilizando Scalar y el estándar OpenAPI.
...
#### Pruebas
Puede probarse utilizando Insomnia o directamente desde la documentación interactiva de Scalar. 
...
La API cuenta con documentación automática e interactiva desarrollada con Scalar y OpenAPI.
Para visualizar la documentación, primero se debe ejecutar el proyecto y luego abrir en el navegador:
